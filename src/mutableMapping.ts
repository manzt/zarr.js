...
export function createProxy<S, T>(
  mapping: S & AsyncMutableMapping<T>
): S & AsyncMutableMappingProxy<T>;
export function createProxy<S, T>(
  mapping: (S & MutableMapping<T>) | (S & AsyncMutableMapping<T>)
): (S & MutableMappingProxy<T>) | (S & AsyncMutableMappingProxy<T>) {
