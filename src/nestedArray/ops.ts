 ...
 * @param selection
 */
export function sliceNestedArray<T extends TypedArray>(
  arr: NestedArrayData,
  shape: number[],
...
export function setNestedArrayToScalar<T extends TypedArray>(
  ...
  const [sliceIndices, outShape] = selectionToSliceIndices(normalizedSelection, destShape) as [
    SliceIndices[],
    number[]
  ];
...
export function setNestedArray<T extends TypedArray>(
  dstArr: NestedArrayData,
...
function _setNestedArray<T extends TypedArray>(
  dstArr: NestedArrayData,
...
function _setNestedArrayToScalar<T extends TypedArray>(
  dstArr: NestedArrayData,
  value: number,
  shape: number[],
